...
class PansegformerHead(SegDETRHead):
    ...
    def __init__(
            ...
            *args,
            ...
            as_two_stage=False,
            transformer=None,
            quality_threshold_things=0.25, #_ 물체의 품질 임계값. 기본값 0.25
            quality_threshold_stuff=0.25, #_ 영역의 품질 임계값. 기본값 0.25
            overlap_threshold_things=0.4, #_ 물체의 겹침 임계값. 기본값 0.4
            overlap_threshold_stuff=0.2, #_ 영역의 겹침 임계값. 기본값 0.2
